...
public class DBProcessorParallel {
	...
	public DBProcessorParallel(final PictureDB db) {
		this(Executors
				.newFixedThreadPool(Runtime.getRuntime().availableProcessors()),
				Runtime.getRuntime().availableProcessors(), db);
	}

	public DBProcessorParallel(final ExecutorService executor,
	...
	public void processFiles(final File rootDir, final File dbDir)
		...
		final PictureFileTraversalParallel pft = new PictureFileTraversalParallel(
				numThreads);
		...
		for (int i = 0; i < numThreads; ++i)
			threads.add(
					new DBProcessorParallelCall(pft, picProc, dbDir, nameGen));
