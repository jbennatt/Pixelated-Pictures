 ...
 *
 */
public class PictureFileTraversalParallel implements Callable<Object> {
	public static final int CAPACITY = 1028;

	public static final File NULL_FILE = PictureFileTraversal.NULL_FILE;
	...
	public PictureFileTraversalParallel(final int numThreads) {
